...
<head>
    <meta charset="UTF-8">
    <title>Director: Faculty Requests</title>
    <style>
        body {
...
<jsp:include page="/WEB-INF/navin.jsp"/>
    ...
    <div class="container">
        <div class="c1">
	    	<h1 style="color: red; text-align: center;">DIRECTOR PAGE</h1>
	    </div>
        <table>
            <thead>
                <tr>
        ...
        <form method="POST" action="bydirector">
            <h2>Action on Request</h2>
            <label for="id">Enter ID:</label>
            <input type="text" name="id"/><br>
            <label for="choice">accept/reject:</label>
